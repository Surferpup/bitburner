...
export async function main(ns) {
	...
	var queenRequiredFiles = ["/scripts/runHacknet.js", "/stocks/stonks.js", "/scripts/hiveManagement.js", "/scripts/buildHive.js",
														"/hacks/supahaka.js", "hackServer.js","/scripts/setStockReserve.js"]
	if (ns.args.length > 0){
		puff = ns.args[0];
	}
	if (ns.args.length > 1){
